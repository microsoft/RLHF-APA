    ...
    def __init__(self, config, **kwargs):  # noqa: C901
        ...
        if self.accelerator.is_main_process and not ray.is_initialized():
            ...
            if config.train.tracker == "wandb":
                ...
                if "method/gen_kwargs/beta" in config_dict_flat and not isinstance(config_dict_flat["method/gen_kwargs/beta"], int):
                    config_dict_flat["method/gen_kwargs/beta_1"] = config_dict_flat["method/gen_kwargs/beta"][0]
                    config_dict_flat["method/gen_kwargs/beta_2"] = config_dict_flat["method/gen_kwargs/beta"][1]
                    config_dict_flat.pop("method/gen_kwargs/beta", None)
                config_dict_flat.pop("optimizer/kwargs/betas", None)
                # print("config:", config_dict_flat)
                self.accelerator.init_trackers(
                    project_name=self.config.train.project_name,
