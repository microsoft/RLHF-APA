...
class SPPOConfig(MethodConfig):
    ...
    loss_str: Optional[str] = 'square'
    adv_coeff_sq: Optional[float] = 1   
    adv_coeff_log: Optional[float] = 1   
    ...
    def loss(
        ...
        logsumexp: TensorType["batch_size", "response_size"],
    ):
        ...
        # print(logprobs.shape, old_logprobs.shape, mask.shape)
